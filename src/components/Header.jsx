...
export const Header = () => {
	...
	const showAuthDialogHandler = (showAuthDialog) => {
	...
	return (
		<>
				...
				<AppBar position='static' color='info'>
					<Toolbar>
						<IconButton
							...
							color='inherit'
							aria-label='menu'
							sx={{ mr: 1, display: { xs: 'none', lg: 'block' } }}
						>
							<FitnessCenterIcon />
						</IconButton>
						<MenuIcon
						...
						<Button
							color='inherit'
							onClick={() => showAuthDialogHandler(true)}
						>
							Login
						</Button>
					</Toolbar>
			...
			/>
			<AuthDialog
				showAuthDialogHandler={showAuthDialogHandler}
